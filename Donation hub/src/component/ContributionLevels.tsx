  ...
  const levels = [
    {
      ...
      title: 'Donor',
      tier: 'Bronze Tier',
      benefits: ['Bronze Badge NFT', 'Community Access', '0-5 ETH Donation'],
    ...
    },
    {
      ...
      title: 'Sponsor',
      tier: 'Silver Tier',
      benefits: ['Silver Badge NFT', 'Voting Rights (x1)', '6-10 ETH Donation'],
    ...
    },
    {
      ...
      title: 'Patron',
      tier: 'Gold Tier',
      benefits: ['Gold Badge NFT', 'Voting Rights (x5)', '11-20 ETH Donation'],
    ...
    },
    {
      ...
      title: 'Benefactor',
      tier: 'Diamond Tier',
      benefits: ['Diamond Badge NFT', 'Governance Seat', '21+ ETH Donation'],
