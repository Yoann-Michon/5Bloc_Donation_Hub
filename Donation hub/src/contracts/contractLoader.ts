...
// This file is imported BEFORE React initialization to ensure contract address is loaded
...
export async function loadContractConfig(): Promise<void> {
    ...
    configPromise = (async () => {
        try {
            // Try to import the generated config.ts
            ...
            // Config file doesn't exist, use .env values
...
// Export a getter function to ensure we always get the latest value
